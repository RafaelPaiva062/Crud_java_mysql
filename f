    ...
    public TelaPrincipal() {
        ...
        JPanel painelCentral = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon(getClass().getResource("/br/com/loja/icones/Tela DE fundo.png"));
        ...
        // Ícone do avatar
        ImageIcon avatarIcon = new ImageIcon(getClass().getResource("/br/com/loja/icones/java.png"));
        ...
        // Atualizar data ao ativ ar a janela
